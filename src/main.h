...
// coinvest, 총 발행량
static const int64_t MAX_MONEY = 888888880 * COIN; // Revert back to 50m, after dev discussion.
// coinvest, pos 보상 %
static const int64_t COIN_YEAR_REWARD = 0.083 * CENT; // 0.083% per year
// coinvest, pos 최대값
static const int64_t MAX_MINT_PROOF_OF_STAKE = 691 * COIN; // max
...
// coinvest, 제네시스 블럭
static const uint256 hashGenesisBlock("0x000003981e021a3f0388266d0d153d26b7eed7dbeaa63011b745c4f662beb673");
...
public:
    ...
    {
        // MamCoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // MamCoin: get transaction coin age
...
public:
    ...
    // MamCoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // MamCoin: two types of block: proof-of-work or proof-of-stake
    ...
    // MamCoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // MamCoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // MamCoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // MamCoin: block index flags
    enum  
    {
